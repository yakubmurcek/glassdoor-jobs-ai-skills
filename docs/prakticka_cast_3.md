...
Komparativní §5.2 ukázala vzorce binárního logit AI požadavku napříč zeměmi. Tato subsekce doplňuje obraz postupnou inkrementální dekompozicí na americkém vzorku, která ukazuje, jakou prediktivní sílu nese firemní profil, profil role a dovednostní profil samostatně. Modely jsou odhadovány ve třech postupných krocích. Model M1 (profil firmy) obsahuje pouze NACE sektor, typ organizace, velikost firmy a region a dosahuje Pseudo R² pouhých 2,4 %. Firemní profil má tedy jako samotný prediktor AI požadavku velmi slabou výpovědní hodnotu. Model M2 (profil role) přidává technologické skill clustery, profesní skupinu, vzdělání a zkušenosti a posouvá Pseudo R² na 11,7 %. Plný Model M3, který k rolovému profilu přidává ještě firemní proměnné, přináší jen marginální zlepšení na 12,9 %. Profil role má tedy řádově vyšší prediktivní sílu než firemní profil a po jeho přidání už firemní proměnné model dále téměř nezlepší. O tom, zda pozice vyžaduje AI, rozhoduje spíše obsah práce než identita zaměstnavatele.
