...
Komparativní analýza rozšiřuje záběr o tři ekonomicky, institucionálně a kulturně odlišné trhy práce s použitím **odlišného datasetu** než sekce 5.1–5.5. Zatímco předchozí analýza byla zaměřena na americký trh práce (USA-only), komparativní část kombinuje data ze tří zemí. Celkový sdružený dataset čítá 44 832 pozorování (USA: 18 464, Indie: 17 114, Německo: 9 254). Po filtraci (confidence ≥ 0,7 a vyloučení inzerátů z let ≤ 2023) zůstalo **38 432 pozorování** (USA: 17 848, Indie: 14 184, Německo: 6 400). Mzdy byly převedeny na USD pevnými kurzy za období scrapingu (EUR/USD = 1,165; INR/USD = 88) a anualizovány s použitím country-specific odpracovaných hodin ročně (USA: 2 080 h, DE: 1 607 h dle OECD 2024, IN: 1 920 h). Odlehlé mzdové hodnoty mimo rozsah 3 000–500 000 USD byly vyřazeny. Jako referenční země je ve všech regresních specifikacích zvolena USA (`ib3.country_id`), protože americký trh tvoří primární benchmark studie a v něm je založena i hlavní USA-only analýza v sekcích 5.1–5.5; koeficienty pro Německo a Indii tak přímo vyjadřují odchylku od amerického trhu.

### 5.6.1 Podíl AI pracovních míst podle země

Podíl AI pozic se výrazně liší mezi zeměmi. USA vykazují nejvyšší podíl AI požadavků (**20,55 %**), Německo je překvapivě blízko s **18,28 %**, zatímco Indie dramaticky zaostává s pouhými **6,29 %**. Tyto rozdíly jsou vysoce statisticky významné (Pearsonův χ²(2) ≈ 1 300; p < 0,001). Zvláště pozoruhodný je rozdíl mezi USA a Německem pouze 2,3 procentního bodu — tj. německý IT trh v agregovaných datech nezaostává za americkým v podílu AI inzerátů nijak dramaticky.

Rozpad na hloubku AI integrace (tier) je informativnější. USA dominují především v kategorii AI Integration (13,19 % všech inzerátů), tj. v pozicích, které AI využívají jako nástroj, zatímco Applied/Core AI (hlubší role věnované přímo vývoji AI) činí 7,36 %. Německo má inverzní profil: AI Integration 9,72 % a Applied/Core AI 8,56 % — což naznačuje, že německý trh sice nabízí méně pozic s AI jako nástrojem, ale relativně více „opravdu AI" rolí. Indie v obou tierech výrazně zaostává (2,78 % AI Integration, 3,51 % Applied/Core AI).
...
Mediánové roční platy (v USD) se řádově liší: **USA 117 869 USD**, **Německo 79 104 USD** (≈ 67 % americké úrovně), **Indie 6 535 USD** (≈ 5,5 % americké úrovně). Průměrné hodnoty jsou 124 617 / 82 056 / 8 324 USD. Tyto rozdíly primárně odrážejí cenovou hladinu a ekonomickou úroveň jednotlivých zemí, nikoliv produktivitu per se.

Klíčovým omezením komparativní analýzy je výrazně odlišné pokrytí mzdových dat. V USA byly mzdové údaje k dispozici u **82,04 %** pozorování (14 642), v Indii u **64,85 %** (9 199), avšak v **Německu pouze u 8,03 %** (514 pozorování). Extrémně nízké pokrytí v Německu je strukturální povahy a odráží německou tradici mzdové mlčenlivosti (Gehaltsgeheimnis), absenci zákonné povinnosti zveřejňovat mzdy v inzerátech (na rozdíl od řady amerických států) a nízkou penetraci Glassdooru v Německu. Z tohoto důvodu je OLS mzdová regrese fakticky porovnáním USA vs. Indie — Německo přispívá pouze ≈ 2,1 % mzdového vzorku a koeficienty pro Německo je nutno interpretovat se značnou opatrností.

Hrubé, nekontrolované mzdové rozdíly podle AI tier v rámci každé země ukazují pozitivní gradient všude: v USA rostou průměrné platy z 119 500 USD (None) přes 140 400 USD (AI Integration) na 150 500 USD (Applied/Core AI), tj. +17 % a +26 %. V Německu činí surová prémie +5 % a +16 %, v Indii pak +25 % a +49 %. Po kontrole observables (viz § 5.6.5) se však tyto hrubé rozdíly výrazně sbližují.

### 5.6.3 Vzdělávací požadavky

Vzdělávací požadavky se mezi zeměmi významně liší (χ²(4) ≈ 2 000; p < 0,001). USA nejčastěji požadují vysokoškolský titul na úrovni bakaláře (**58,47 %** Bachelor + 1,88 % Master+ = 60,35 %), Indie v 52,0 % případů (49,32 % Bachelor + 2,68 % Master+), Německo pouze ve 33,28 % (26,89 % Bachelor + 6,39 % Master+). Nízký podíl vysokoškolských požadavků v Německu koresponduje s tradicí duálního vzdělávacího systému, kde profesní kvalifikace získaná učňovským vzděláváním (Ausbildung) je zaměstnavateli uznávána jako plnohodnotná alternativa k univerzitnímu titulu. Naopak relativně vysoký podíl Master+ v Německu (6,4 % oproti 1,9 % v USA) naznačuje bipolární strukturu: buď nevyžadovaný titul vůbec (duální systém), nebo nadstandardní akademická kvalifikace.

### 5.6.4 Sdružený OLS model s country fixed effects

Pro testování, zda se AI mzdová prémie liší mezi zeměmi, byl odhadnut sdružený (pooled) Model FE-C s plnou sadou kontrol (firemní profil, skill clustery, profesní skupina, vzdělání, zkušenosti) a fixními efekty na zemi (dummy proměnné pro Německo a Indii, referenční kategorie = **USA**). Model dosáhl R² = 0,934 (N = 23 897), přičemž vysoká hodnota R² je dána především tím, že country FE absorbují řádové mzdové rozdíly mezi ekonomikami; per-country US-only specifikace dává realističtější R² = 0,38, což odpovídá typické vysvětlovací síle Mincerových rovnic.

Klíčové koeficienty sdruženého modelu FE-C: **AI Integration +10,08 %** (koeficient 0,101; p < 0,001), **Applied/Core AI +13,31 %** (koeficient 0,133; p < 0,001). Německo vykazuje ceteris paribus platy přibližně o 41 % nižší než USA (koeficient −0,533; exp(β) − 1 = −0,413), Indie dokonce o 94 % nižší (koeficient −2,799; exp(β) − 1 = −0,939). Možnost remote práce nese prémii +10,7 % (koeficient 0,107; p < 0,001). Přidání skill clusterů a profesní skupiny mezi Modelem FE-A a FE-C sníží surové AI koeficienty (z +13,8 % / +20,4 % v Modelu FE-A na +10,1 % / +13,3 % v Modelu FE-C), což je konzistentní s mediací části AI prémie přes typ role a technologický stack — analogicky ke zjištěním v USA-only analýze (§ 5.3).

### 5.6.5 Interakční model — homogenita AI prémie napříč zeměmi

Klíčovým testem komparativní analýzy je otázka, zda se AI mzdová prémie statisticky významně liší mezi zeměmi. K tomuto účelu byl odhadnut interakční model s plnou interakcí country × ai_level ve specifikaci FE-C.

Interakční koeficienty (Německo × AI Integration: +0,075, p = 0,589; Německo × Applied AI: +0,013, p = 0,930; Indie × AI Integration: −0,027, p = 0,470; Indie × Applied AI: −0,016, p = 0,693) nejsou ani jednotlivě, ani společně statisticky významné. **Společný Waldův F-test všech čtyř interakčních členů dává F(4; 23 837) = 0,24; p = 0,9154.**

Tento nulový výsledek je hlavním zjištěním komparativní kapitoly: **mezi zeměmi neexistuje statisticky významný rozdíl v čisté AI mzdové prémii**. Průměrné marginální efekty ai_level podle země (z interakčního modelu) toto potvrzují:

| Země | AI Integration (dy/dx ln plat) | Applied/Core AI | Signifikance |
|------|-------------------------------|-----------------|--------------|
| USA  | +10,3 %                       | +13,6 %         | obě p < 0,001 |
| Německo | +17,9 %                    | +14,8 %         | obě p > 0,20 (n. s.) |
| Indie | +7,7 %                       | +12,0 %         | p = 0,037 a p = 0,003 |

Bodové odhady pro Německo jsou sice číselně vyšší než pro USA, ale kvůli extrémně malému N německého mzdového vzorku (514 pozorování, z toho 72 AI Integration a 46 Applied/Core AI) jsou intervaly spolehlivosti velmi široké a rozdíly statisticky nerozlišitelné. Pro Indii, která tvoří 38 % mzdového vzorku, je bodový odhad AI prémie téměř identický s americkým (+7,7 až +12,0 % vs. +10,3 až +13,6 %).

Rozdíly mezi zeměmi se tedy projevují ve **frekvenci** AI pracovních míst (viz § 5.6.6), nikoliv v jejich **mzdovém ohodnocení** relativně k non-AI pozicím. Je však nutné interpretovat tento výsledek s přiměřenou opatrností: Německo přispívá do mzdového vzorku pouhými 2,1 % celku, což výrazně omezuje statistickou sílu testu pro detekci případných německých odchylek. Interakční model tak fakticky testuje homogenitu AI prémie mezi USA a Indií s vysokou silou, zatímco pro Německo je schopnost testu odhalit i středně velké rozdíly omezená. Přesto je vysoká p-hodnota společného F-testu (0,9154) natolik vzdálena hranici významnosti, že závěr o aproximativní homogenitě AI prémie je oprávněný — alespoň pro dvojici USA–Indie, která tvoří 97,9 % mzdového vzorku.

### 5.6.6 Multinomiální logit — pravděpodobnost AI pozice podle země

Zatímco mzdová prémie je napříč zeměmi homogenní, pravděpodobnost narazit na AI pozici se mezi zeměmi dramaticky liší. Binární logit pro P(has_ai) s plnou sadou kontrol (sektor, firemní profil, skill clustery, profesní skupina, vzdělání, zkušenosti; N = 32 279 po vyřazení cirkulárních clusterů Generative AI a Data Science/ML) dává tyto průměrné marginální efekty příslušnosti k zemi oproti USA:

- **Německo: −1,10 p. b.** (p = 0,633) — statisticky nerozlišitelné od USA
- **Indie: −14,16 p. b.** (p < 0,001) — dramatický pokles pravděpodobnosti AI pozice i po kontrole kompozice

Multinomiální logit (N = 32 279) tento obraz rozpadá podle hloubky AI integrace. Průměrné marginální efekty country dummy (oproti USA, v plné specifikaci):

| Země | P(AI Integration) | P(Applied/Core AI) |
|------|-------------------|--------------------|
| Německo | −1,01 p. b. (p = 0,610) | −0,29 p. b. (p = 0,834) |
| Indie | **−10,33 p. b.** (p < 0,001) | **−3,78 p. b.** (p < 0,001) |

Německo je tedy po kontrole observables statisticky k nerozlišení od USA — ani v pravděpodobnosti AI Integration, ani Applied/Core AI. Surový rozdíl 2,3 p. b. v podílu AI pozic mezi USA a Německem se po kontrole skill clusterů, profesní skupiny a firemního profilu zcela ztrácí. To naznačuje, že **surové rozdíly mezi USA a Německem v AI penetraci jsou z podstatné části kompozičním efektem** — odlišnou strukturou pozic a dovedností nabízených na obou trzích, nikoliv systematicky odlišným přístupem k AI. Indie naproti tomu zůstává silně odlišná i po kontrole: bude-li inzerát jinak identický (stejný sektor, velikost firmy, technologický stack, požadované vzdělání a zkušenosti), v Indii má o 10,3 p. b. nižší pravděpodobnost být klasifikován jako AI Integration a o 3,8 p. b. nižší pravděpodobnost jako Applied/Core AI než v USA.

Rozdílná dynamika hloubky AI adopce je zachycena i bodově v RRR: nejsilnějšími prediktory AI klasifikace v komparativním modelu zůstávají — stejně jako v USA-only analýze — **Generative AI** a **Data Science / ML** skill clustery, zatímco vliv země je po jejich kontrole druhořadý pro volbu mezi AI tieri. Hlavní roli země hraje tedy na úrovni **zda** je pozice vůbec AI, ne na úrovni **jaké** AI.

**Souhrnné komparativní zjištění:** AI skill je v amerických, německých i indických IT inzerátech spojen se srovnatelně velkou čistou mzdovou prémií v řádu 10–14 %. Rozdíl mezi zeměmi není v tom, kolik trh platí za AI dovednosti, ale v tom, kolik AI pozic vůbec nabízí. Americký a německý trh se při kontrole kompozice jeví jako ekvivalentní v penetraci AI poptávky, zatímco indický IT trh vykazuje i po kontrole observables o ≈ 14 procentních bodů nižší pravděpodobnost AI pozice oproti USA.
